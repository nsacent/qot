...
from .views import (
    ...
    RegisterCurrentSessionAPIView,
    RevokeUserSessionAPIView,
    RevokeOtherUserSessionsAPIView,
    MeAPIView,
...
urlpatterns = [
    ...
    path("sessions/", UserSessionListAPIView.as_view(), name="sessions"),
    path(
        "sessions/register-current/",
        RegisterCurrentSessionAPIView.as_view(),
        name="sessions_register_current",
    ),
    path(
        "sessions/sign-out-others/",
        RevokeOtherUserSessionsAPIView.as_view(),
        name="sessions_sign_out_others",
    ),
    path(
        "sessions/<uuid:session_id>/",
        RevokeUserSessionAPIView.as_view(),
